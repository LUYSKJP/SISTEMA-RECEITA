...
5. Baixe o CodeIgniter 3 e copie a pasta `system` para a raiz do projeto (ela deve ficar ao lado de `application`). Sem essa pasta, aparecerá a mensagem **"Sistema do CodeIgniter não encontrado"**.
